...
**Status:** Resolved -- Compatible gradient, not a contradiction. ~100 lines = practical sweet spot, ~200 lines = hard ceiling, ~150-200 instructions = different unit (instructions vs lines). Official Anthropic guidance now says "under 500 lines" (see tools-and-integrations.md). No KB edits needed.
